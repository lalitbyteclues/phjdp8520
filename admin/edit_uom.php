                                    ...
                                    <form class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" class="form-control" id="uom_name" required placeholder="Name">
                                            </div>
                                        </div>
  ...
  <input type="text" class="form-control" id="pro_cat" >
        ...
        {   var username = "<?php echo $_SESSION['admin_email']; ?>";
            ...
            spiderG.getLoginToken(username, function()
            {
              ...
              $.ajax({
                  type: "GET",
                  url: "http://vpn.spiderg.com:8081/SpiderGAPIServer/api/uom/"+uom_id,
                ...
                success: function (people ,textStatus) 
                { 
                   $('#uom_name').val(people.name);
                   $('#symbol').val(people.symbol);
                   $('#stdprecision').val(people.stdprecision);
                },
                error: function (err) {
                  console.log(err);
