...
<thead>
<tr class="headings"><th>S.No. </th><th>Name</th><th>Location </th><th>taxid </th><th>oid </th></tr></thead>
...
$.ajax({type: "GET",url: "http://vpn.spiderg.com:8081/SpiderGAPIServer/api/org?limit=100000&orderby=register_ts&extensionid=7D6AACFA15614E1CBE3626B7513191F0",contentType:'application/json',headers:{'SPIDERG-API-Key': 'e5e3b300-31e9-4ad2-a705-4f8935218fcb','SPIDERG-Authorization': "SPIDERGAUTH "+ createAuthenticationHeader(username,password,loginToken,loginTokenTS)},success: function (people){
var i = 1;
for(var j=0; j< people.length; j++)
{
	notesTable.row.add([i,people[j].name,people[j].location,people[j].taxid,people[j].oid]).draw();
	i++; 
}},error: function (err) {
console.log(err);}});});
});
