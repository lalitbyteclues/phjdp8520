          ...
          notesTable =   $('#example').DataTable();
            ...
            $.ajax({
                ...
                { 
                   ...
                   {
                    //notesTable.row.add([i,people[j].name,people[j].isdefault,"<a href='edit_category.php?id="+people[j].id+"'>Edit</a> <a href='javascript:void(0)' onclick='deletepro(\""+people[j].id+"\")'>Delete</a>"]).draw();
                     notesTable.row.add([i,people[j].name,people[j].isdefault," <a href='javascript:void(0)' onclick='deletepro(\""+people[j].id+"\")'>Delete</a>"]).draw();
           ...
           var r = confirm('Are you really want to delete this ?');
            if(r==true)
            {
                ...
                spiderG.getLoginToken(username, function()
                {
                  ...
                  $.ajax({
                      type: "DELETE",
                      url: "http://vpn.spiderg.com:8081/SpiderGAPIServer/api/product/category/"+id,
