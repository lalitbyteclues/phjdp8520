                                    ...
                                    <form class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input required type="text" required class="form-control" id="cat_name" placeholder="Product Name">
                                            </div>
                                        </div>
                                       
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">isdefault</label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                 <input type="radio" value="Y" name="isdefault" checked id="sold_y"> Yes
                                                <input type="radio" value="N" name="isdefault"  id="sold_n"> No
                                      ...
                                      <div class="ln_solid"></div>
                                        <div class="form-group">
                                            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                                ...
                                                <button type="button" onclick="addprocategory('<?php echo $_SESSION['admin_email']; ?>','<?php echo $_COOKIE['password']; ?>')" class="btn btn-success">Submit</button>
