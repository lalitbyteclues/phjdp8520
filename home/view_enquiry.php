                    ...
                    <div class="row"> 
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="col-md-7"> 
    <div class="form-group"> <label class="control-label col-md-3 col-sm-3 col-xs-12">Document No.</label><div class="col-md-9 col-sm-9 col-xs-12"> <span id="doc_no"></span> </div> </div> <br>
 <div class="form-group"> <label class="control-label col-md-3 col-sm-3 col-xs-12">Issue Date</label>
...
<br>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Sent To</label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
...
console.log(currdate);
            ...
            function getuom(uomid)
            {
                ...
                var loginToken = spiderG['loginToken'];
                var loginTokenTS = spiderG['loginTokenTS'];
                $.ajax({type: "GET",url: "http://vpn.spiderg.com:8081/SpiderGAPIServer/api/uom/"+uomid,contentType:'application/json',
                    headers: { 
                            'SPIDERG-API-Key': 'e5e3b300-31e9-4ad2-a705-4f8935218fcb',
                            'SPIDERG-Authorization': "SPIDERGAUTH "+ createAuthenticationHeader(username,password,loginToken,loginTokenTS)
                        },
