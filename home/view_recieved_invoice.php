...
-->
                                        <div class="form-group">
                                         ...
                                         <div class="form-group col-md-12">
                                            <label style="margin-left: -1%;" class="control-label col-md-3 col-sm-3 col-xs-12">Price/Unit</label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <span id="price"></span>
                                            </div>
                                        </div>
										...
										<div class="form-group col-md-12">
                                            <label style="margin-left: -1%;" class="control-label col-md-3 col-sm-3 col-xs-12">Net Invoice Total</label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
										...
										<div class="form-group col-md-12">
                                            <label style="margin-left: -1%;" class="control-label col-md-3 col-sm-3 col-xs-12">Invoice Amount</label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <span id="invoiceamt"></span> 
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                       ...
                                       <div class="form-group col-md-12">
                                            ...
                                            <span id="cstmlink"></span>
                                              <input type="button" class="btn btn-primary"  id="acceptpo" value="Accept Invoice" /> 
                                            </div>
                                        </div>  
                                    <!-- </div> -->
                                </div></div>
<div class="col-md-5" > <h2>Messages</h2> 
...
socket.on("message_status", function(msg) {  });
...
messageslist+="<div class='bubble-container'> <div class='avatar avatar-"+(msg.history[k].username==username?'right':'left')+"'><img src=' data:image/png;base64,'/></div><div class='bubble bubble-"+(msg.history[k].username==username?'right':'left')+"'><b>"+(msg.history[k].username==username?'Me':msg.history[k].username)+"</b><br>"+msg.history[k].message+"<br>"+moment(d).format("lll")+"</div></div>";
 ...
 $('#acceptpo').click(function(){ 
	 if($('#acceptpo').val()=="Accept Invoice"){
...
var channel="";
	...
	spiderG.getLoginToken(username, function(){
		var loginToken = spiderG['loginToken'];
		var loginTokenTS = spiderG['loginTokenTS'];
		$.ajax({type:"GET",url:"http://vpn.spiderg.com:8081/SpiderGAPIServer/api/invoice/"+invoice_id,contentType:'application/json',headers:{'SPIDERG-API-Key': 'e5e3b300-31e9-4ad2-a705-4f8935218fcb','SPIDERG-Authorization': "SPIDERGAUTH "+ createAuthenticationHeader(username,password,loginToken,loginTokenTS)},success:function(data){
			people = data; 
            channel=people.channel;
            $("#doc_no").html(people.documentno);
			$.ajax({type:"GET",url:"http://vpn.spiderg.com:8081/SpiderGAPIServer/api/mailbox/invoice/"+people.id,contentType:'application/json',headers: {'SPIDERG-API-Key': 'e5e3b300-31e9-4ad2-a705-4f8935218fcb','SPIDERG-Authorization': "SPIDERGAUTH "+ createAuthenticationHeader(username,password,loginToken,loginTokenTS)},success:function (data){
			mailboxlist = data;  
			mailid=mailboxlist.id;
			getorgname(mailboxlist.senderorg); 
            ...
            function getorgname(org)
            {
                ...
                var loginToken = spiderG['loginToken'];
                var loginTokenTS = spiderG['loginTokenTS'];
                $.ajax({type:"GET",url:"http://vpn.spiderg.com:8081/SpiderGAPIServer/api/org?orgid="+org,contentType:'application/json',headers:{'SPIDERG-API-Key':'e5e3b300-31e9-4ad2-a705-4f8935218fcb','SPIDERG-Authorization': "SPIDERGAUTH "+ createAuthenticationHeader(username,password,loginToken,loginTokenTS)},success: function (data){
					people1 = data; 
	...
	<style>
	#browser-window{background: url("../images/background.png") ;height: 538px;width: 335px;padding:65px 11px 10px 17px;margin: auto;position:relative;float:left;}
