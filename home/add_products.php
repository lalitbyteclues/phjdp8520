                    ...
                    <div class="row"> 
                       <div class="col-md-offset-2 col-md-8 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">								  
                                    <br />
                                    <form class="form-horizontal form-label-left"   enctype="multipart/form-data"  method="post"  id="addproduct"> 
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Product Name</label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input type="text" required label="Product Name" parsley-required="true" class="form-control" id="p_name" name="p_name" placeholder="Product Name">
                                            </div>
                                        </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                               <input type="radio" value="Y" name="ispurchased"   id="purchas_y"> Yes
                                                <input type="radio" value="N" name="ispurchased" checked id="purchas_n"> No
                                            </div>
                                        </div>
                                          <div class="form-group">
					 ...
					 <a title="download sample Excel Format" href="http://pharmerz.com/uploads/product.xlsx" target="_blank">Download Sample Excel Format &nbsp; <i class="fa fa-cloud-download fa-5"></i></a> </div>
							  ...
							  <div class="form-group"> <input name="userImage" id="userImage" required type="file" class="demoInputBox" /></div>
								  <div class="form-group">
									 <input type="submit" id="btnSubmit" value="Submit" class="btnSubmit" /></div>
...
.fa-5 {font-size:2em;}								  
									...
									</style><script>/* jquery.form.min.js */
   ...
   if($_FILES['file_profileimage']['name']!='')
	...
	$( document ).ready(function() 
		...
		var imgurl='<?php if(isset($files["url"])){ echo $files["url"];} else { echo "";} ?>';
			var product={}  
			if(imgurl==""){
			 product = {"name":"<?php echo $_POST['p_name']; ?>","uom":"<?php echo $_POST['drpdwn']; ?>","category_id":"<?php echo $_POST['catdrpdwn']; ?>","sku":"<?php echo $_POST['sku']; ?>","upc":"<?php echo $_POST['upc']; ?>","ispurchased":"<?php echo $_POST['ispurchased']; ?>","issold":"<?php echo $_POST['issold']; ?>","ispublic":"<?php echo $_POST['ispublic']; ?>","notes":"<?php echo $_POST['notes']; ?>",};
			}else{  
			  product = {"name":"<?php echo $_POST['p_name']; ?>","uom":"<?php echo $_POST['drpdwn']; ?>","category_id":"<?php echo $_POST['catdrpdwn']; ?>","sku":"<?php echo $_POST['sku']; ?>","upc":"<?php echo $_POST['upc']; ?>","ispurchased":"<?php echo $_POST['ispurchased']; ?>","issold":"<?php echo $_POST['issold']; ?>","ispublic":"<?php echo $_POST['ispublic']; ?>","notes":"<?php echo $_POST['notes']; ?>","imgurl":imgurl,}
			}  
          var objectDataString = JSON.stringify(product); 
		     var username = "<?php echo $_SESSION['user_email']; ?>";
            var password = "<?php echo $_COOKIE['password']; ?>";
...
console.log($('#purchas_n')); 
if($('#purchas_n').is(':checked') && $('#sold_n').is(':checked'))
{ 
alert("Please select Purchase or Sold Type");
return false;
} 
});
</script>
