              ...
              <div class="container">
                <div class="row" style="padding-top: 0px;">
                  ...
                  <div class="col-xs-6">
                          ...
                          <!-- End Header Currency -->
                          <div class="welcome-msg hidden-xs"> Welcome to Pharmerz Beta Version 1.0! </div>
                        </div>
                        <div class="col-xs-6">
                          <!-- Header Top Links -->
                          <div class="toplinks">
                            <div class="links">
                              ...
                              <div class="myaccount"><a title="My Account" href="/home/index.php"><span class="hidden-xs">My Account</span></a></div>
                  ...
                  <div class="header container">
                    <div class="row">
                      <div class="col-lg-2 col-sm-3 col-md-2 col-xs-12">
                        <!-- Header Logo -->
                        <a class="logo" title="Pharmerz" href="/" style="margin-top: 0px;"><img alt="Pharmerz" src="/images/logo_pharmerz.jpg"></a>
                        <!-- End Header Logo -->
                      </div>
                      <div class="col-lg-7 col-sm-4 col-md-6 col-xs-12" style="padding-top: 4px;">
                        <!-- Search-col -->
                        <div class="search-box" style="bottom: 20px;">
                          <form action="cat" method="POST" id="search_mini_form" name="Categories">
                            <select name="category_id" class="cate-dropdown hidden-xs">
                              <option value="0">All Categories</option>
                              <option value="36">API</option>
                              <option value="37">Intermediates</option>
                              <option value="42">Pellets</option>
                      ...
                      <div class="col-lg-3 col-sm-5 col-md-4 col-xs-12">
                        <div style="padding-top: 5px;"><span style="font-size: 12px;">Platform provided by &nbsp;</span><a href="http://www.spiderg.com"><img src="/images/Spider4.png" style="position: absolute; bottom: 58px;"></a>
                        </div>
                        <div class="top-cart-contain" style="margin-right: 12px;">
                          <div class="mini-cart">
                            <div data-toggle="dropdown" data-hover="dropdown" class="basket dropdown-toggle"> <a href="shopping_cart.php" style="padding-top: 8px;"> <i class="icon-cart"></i>
                              <div class="cart-box"><span class="title">My Cart</span><span id="cart-total"> <?php if(isset($_COOKIE['cart_total'])){echo $_COOKIE['cart_total'];}else{ echo '0'; }?> </span></div>
                            </a></div>
                            <!-- <div>
                        ...
                        <span class="or" style="padding-top: 5px;"> | </span>
                        <div class="login"><a title="Login" href="signup.html" id="login"><span>Log In</span></a></div>
                        <?php } ?>
                      </div>
                      <!-- End Top Cart -->
                    </div>
                ...
                <nav>
                  <div class="container">
                    <div class="nav-inner">
                              ...
                              <li>
                                <ul class="topnav">
                                  <li class="level0 nav-6 level-top first parent"> <a class="level-top" href="/"> <span>Home</span> </a>
                                    <ul class="level0">
                                      <li class="level1"><a href="/"><span>What is Pharmerz</span></a> </li>
                                      <li class="level1"><a href="#"><span>Why should I join Pharmerz</span></a> </li>
                                      <li class="level1"><a href="/"><span>How should I join Pharmerz</span></a> </li>
                                      <li class="level1"><a href="../jewellery/index.html"><span>Who are we</span></a> </li>
                                      <li class="level1"><a href="../jewellery/index.html"><span>When Pharmerz started</span></a> </li>
                                      <li class="level1"><a href="../jewellery/index.html"><span>Where is Pharmarz</span></a> </li>
                                    </ul>
                                  </li>
                                  <li class="level0 nav-6 level-top"> <a class="level-top" href="api.php" id="apiLink"> <span>Products</span> </a>
                                    <ul class="level0">
                                      <li class="level1 first"><a href="api.php" id="apiLink"><span>APIs</span></a></li>
                                      <!-- <li class="level1 nav-10-2"> <a href="api.html" id="apiLink"> <span>Intermediates</span> </a> </li> -->
                                      <li class="level1 nav-10-3"> <a href="api.php" id="apiLink"> <span>Intermediates</span> </a> </li>
                                      <li class="level1 nav-10-3"> <a href="api.php" id="apiLink"> <span>Pellets</span> </a> </li>
                                      <li class="level1 nav-10-3"> <a href="api.php" id="apiLink"> <span>Finished&nbsp;Formulation</span> </a> </li>
                                  ...
                                  <li class="level0 parent drop-menu"><a href="/"><span>Blog</span> </a>
                                    <ul class="level1">
                                      <li class="level1 first"><a href="/"><span>Table View</span></a></li>
                                      <li class="level1 nav-10-2"> <a href="/"> <span>Single Post</span> </a> </li>
                                    </ul>
                                  </li>
                      ...
                      <!--End mobile-menu -->
                      <!-- <a class="logo-small" title="Pharmerz" href="index.html"><img alt="Pharmerz" src="/images/logo_pharmerz-croped.png"></a> -->
                      <ul id="nav" class="hidden-xs">
                        <li class="level0 parent drop-menu"><a href="/" class="active"><span>Home</span> </a>
                          <ul class="level1 home">
                            <li class="level1"><a href="#WhatIsPharmerz"><span>What is Pharmerz</span></a> </li>
                            <li class="level1"><a href="#WhoCanJoinPharmerz"><span>Who Can Join Pharmerz</span></a> </li>
                            <li class="level1"><a href="#WhyShouldYouJoinPharmerz"><span>Why Should You Join Pharmerz</span></a></li>
                            <!-- <li class="level1"><a href="#WhoAreAllInPharmerz"><span>Who are all in Pharmerz?</span></a> </li> -->
                            <li class="level1"><a href="#WhenShouldYouJoinPharmerz"><span>When Should You Join Pharmerz</span></a></li>
                            <li class="level1"><a href="#WhereIsPharmerz"><span>Where is Pharmerz</span></a></li>
                          </ul>
                        </li>
                        <li class="level0 parent drop-menu"><a href="api.php"><span>Products</span> </a>
                          <ul class="level1">
                            <li class="level1 first"><a href="api.php"><span>APIs</span></a></li>
                            <li class="level1 nav-10-2"> <a href="api.php" id="apiLink"> <span>Intermediates</span> </a> </li>
                            <li class="level1 nav-10-3"> <a href="api.php" id="paletsLink"> <span>Pellets</span> </a> </li>
                            <li class="level1 nav-10-3"> <a href="api.php" id="apiLink"> <span>Finished Formulation</span> </a> </li>
                            <!-- <li class="level1 nav-10-4"> <a href="shopping_cart.html"> <span>Shopping Cart</span> </a> </li> -->
                            <!-- <li class="level1 first parent"><a href="checkout.html"><span>Checkout</span></a>
                              <ul class="level2">
                        ...
                        <li class="level0 parent drop-menu"> <a href="index.php#WhereIsPharmerz" class="level-top"> <span>Support</span> </a>
                          <!-- <ul class="level1">
                            <li class="level1"><a href="index.html"><span>FAQs</span></a> </li>
                            <li class="level1"><a href="index.html"><span>Forums</span></a> </li>
                            <li class="level1"><a href="index.html"><span>How to get started?</span></a></li>
                          </ul> -->
...
<li class="level0 parent drop-menu"> <a href="/contact_us.php" class="level-top"> <span>Contact Us</span> </a>
  <!-- <ul class="level1">
    <li class="level1"><a href="index.html"><span>FAQs</span></a> </li>
    <li class="level1"><a href="../digital/index.html"><span>Forums</span></a> </li>
    <li class="level1"><a href="../furniture/index.html"><span>How to get started?</span></a></li>
  </ul> -->
<!-- <li class="level0 nav-7 level-top parent"> <a href="grid.html" class="level-top"> <span>Contact Us</span> </a>
<div class="level0-wrapper dropdown-6col" style="display: none;">
  <div class="level0-wrapper2">  -->
    <!--nav-block nav-block-center-->
...
<!-- <li class="level0 nav-5 level-top first"> <a class="level-top" href="grid.html"> <span>Electronics1</span> </a>
...
<!-- <ul class="level1">
  ...
  <!--level1-->
  <!--sub sub category-->
<!-- <div class="cat-img"><img src="/images/e-img1.jpg" alt="Mobiles Accesories"></div>
</li> -->
<!--level1 nav-6-1 parent item-->
...
<!-- <ul class="level1">
  ...
  <!--level1-->
  <!--sub sub category-->
<!-- <div class="cat-img"><img src="/images/e-img1.jpg" alt="Cameras"></div>
</li> -->
<!--level1 nav-6-1 parent item-->
...
<!-- <ul class="level1">
  ...
  <!--level1-->
  <!--sub sub category-->
<!-- <div class="cat-img"><img src="/images/e-img1.jpg" alt="Audio &amp; Video"></div>
</li> -->
<!--level1 nav-6-1 parent item-->
<!-- </ul> -->
<!--level0-->
...
<!--level0-wrapper2-->
<!-- </div>
</li> --> <!-- Furniture nav-link end -->
<li class="level0 parent drop-menu"><a href="index.html"><span>Blog</span> </a>
  <!-- <ul style="display: none;" class="level1">
    <li class="level1 first"><a href="index.html"><span>Table View</span></a> </li>
    <li class="level1 parent"><a href="index.html"><span>Single Post</span></a> </li>
  </ul> -->
</li>
...
<div class="grid12-5">
<div class="custom_img"><a href="#"><img src="/images/custom-img1.jpg" alt="custom img2"></a></div>
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue.</p>
<button class="learn_more_btn" title="Add to Cart" type="button"><span>Learn More</span></button>
</div>
<div class="grid12-5">
<div class="custom_img"><a href="#"><img src="/images/custom-img1.jpg" alt="custom img3"></a></div>
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue.</p>
<button class="learn_more_btn" title="Add to Cart" type="button"><span>Learn More</span></button>
</div>
<div class="grid12-5">
<div class="custom_img"><a href="#"><img src="/images/custom-img1.jpg" alt="custom img4"></a></div>
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue.</p>
<button class="learn_more_btn" title="Add to Cart" type="button"><span>Learn More</span></button>
</div>
</div>
