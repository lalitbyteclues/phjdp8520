...
!function ($) {
  ...
  */
    ...
    */
    this.messages = {
      ...
      , type: {
          ...
          , validfloat:  "This value should be a valid number."
          , digits:     "This value should be digits."
		  , float:     "This value should be a valid number."
          , dateIso:    "This value should be a valid date (YYYY-MM-DD)."
          , alphanum:   "This value should be alphanumeric."
          , phone:      "This value should be a valid phone number."
		      ,alpha:       "This value sholud be alphabetic"
        }
  ...
  ParsleyUI.prototype = {
    ...
    */
	...
	// customized_by_aneet
    , addError: function ( error, label ) {
      for ( var constraint in error ) {
        var liTemplate = $( this.options.errors.errorElem ).addClass( constraint );
		
		// customized_by_aneet
		error[ constraint ] = error[ constraint ].replace('This value', label);
    ...
    */
	...
	// customized_by_aneet
    , updateError: function ( error, label ) {
      for ( var constraint in error ) {
        if ( error[ constraint ] !==  $( this.ulError +  " > li." + constraint ).html() ) {
		  // customized_by_aneet
          this.removeError( constraint ).addError( error, label );
        }
      }
    ...
    */
	...
	// customized_by_aneet
    , manageError: function ( constraint, label ) {
      ...
      // add liError if not shown. update if already exist
		...
		// customized_by_aneet
      !$( this.ulError + ' .' + liClass ).length ? this.addError( liError,label ) : this.updateError( liError,label );
    ...
    , manageValidationResult: function () {
      ...
      if ( true === this.valid ) {
        ...
        if ( true === this.options.priorityEnabled ) {
		  ...
		  // customized_by_aneet
          this.UI.manageError( constraint,this.$element.attr('label'));
        } else {
          for ( var i = 0; i < errors.length; i++ )
		  	
			// customized_by_aneet
            this.UI.manageError( errors[ i ],this.$element.attr('label'));
        }
  ...
  */
  $.fn.parsley.defaults = {
    ...
    , inputs: 'input, textarea, select, file'         // Default supported inputs.
